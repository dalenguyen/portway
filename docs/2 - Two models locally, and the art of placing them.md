...
- **Ports 8010/8011, not 8000/8001.** Series.md uses 8000/8001; this post uses 8010/8011 because port 8000 was taken on the author's machine (Apollo MCP server). Pick any two free ports — placement isn't about specific numbers.
